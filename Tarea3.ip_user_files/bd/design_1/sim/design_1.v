...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_clkrst_cnt=15,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire processing_FSM_0_done;
  wire [31:0]processing_FSM_0_m_axis_TDATA;
  wire [3:0]processing_FSM_0_m_axis_TKEEP;
  wire processing_FSM_0_m_axis_TLAST;
  wire processing_FSM_0_m_axis_TREADY;
  wire processing_FSM_0_m_axis_TVALID;
  wire [31:0]processing_FSM_0_n_matches;
  ...
  design_1_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_125M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(processing_FSM_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep(processing_FSM_0_m_axis_TKEEP),
        .s_axis_s2mm_tlast(processing_FSM_0_m_axis_TLAST),
        .s_axis_s2mm_tready(processing_FSM_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(processing_FSM_0_m_axis_TVALID));
  ...
  design_1_axiregs_0_0 axiregs_0
       (.in_matches(processing_FSM_0_n_matches),
        .in_status({processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done,processing_FSM_0_done}),
        .s00_axi_aclk(processing_system7_0_FCLK_CLK0),
        .s00_axi_araddr(smartconnect_1_M02_AXI_ARADDR),
        .s00_axi_aresetn(rst_ps7_0_125M_peripheral_aresetn),
        .s00_axi_arprot(smartconnect_1_M02_AXI_ARPROT),
        .s00_axi_arready(smartconnect_1_M02_AXI_ARREADY),
        .s00_axi_arvalid(smartconnect_1_M02_AXI_ARVALID),
        .s00_axi_awaddr(smartconnect_1_M02_AXI_AWADDR),
        .s00_axi_awprot(smartconnect_1_M02_AXI_AWPROT),
        .s00_axi_awready(smartconnect_1_M02_AXI_AWREADY),
        .s00_axi_awvalid(smartconnect_1_M02_AXI_AWVALID),
        .s00_axi_bready(smartconnect_1_M02_AXI_BREADY),
        .s00_axi_bresp(smartconnect_1_M02_AXI_BRESP),
        .s00_axi_bvalid(smartconnect_1_M02_AXI_BVALID),
        .s00_axi_rdata(smartconnect_1_M02_AXI_RDATA),
        .s00_axi_rready(smartconnect_1_M02_AXI_RREADY),
        .s00_axi_rresp(smartconnect_1_M02_AXI_RRESP),
        .s00_axi_rvalid(smartconnect_1_M02_AXI_RVALID),
        .s00_axi_wdata(smartconnect_1_M02_AXI_WDATA),
        .s00_axi_wready(smartconnect_1_M02_AXI_WREADY),
        .s00_axi_wstrb(smartconnect_1_M02_AXI_WSTRB),
        .s00_axi_wvalid(smartconnect_1_M02_AXI_WVALID));
  design_1_processing_FSM_0_2 processing_FSM_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .done(processing_FSM_0_done),
        .m_axis_tdata(processing_FSM_0_m_axis_TDATA),
        .m_axis_tkeep(processing_FSM_0_m_axis_TKEEP),
        .m_axis_tlast(processing_FSM_0_m_axis_TLAST),
        .m_axis_tready(processing_FSM_0_m_axis_TREADY),
        .m_axis_tvalid(processing_FSM_0_m_axis_TVALID),
        .n_matches(processing_FSM_0_n_matches),
        .reset(rst_ps7_0_125M_peripheral_aresetn),
        .s_axis1_tdata(axi_dma_0_M_AXIS_MM2S_TDATA),
        .s_axis1_tkeep(axi_dma_0_M_AXIS_MM2S_TKEEP),
